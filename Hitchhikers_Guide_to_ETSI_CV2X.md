...
Every one of these is defined twice: once in prose (the service spec) and once formally (the **ASN.1 schema**, see §5) — the ASN.1 is what actually goes over the air, UPER-encoded.
...
**Release 2** (current, actively rolling out through 2024–2026): the C-V2X-relevant wave —
...
**C-V2X Plugtests™** (ETSI + 5GAA, hosted by DEKRA) is the flagship interoperability programme — a running series, not a one-off:
